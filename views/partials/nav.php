            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" aria-current="page" class=" <?= urlis('/') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Home</a>
